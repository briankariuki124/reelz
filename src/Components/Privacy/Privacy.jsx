...
import image from "../../Assets/Projects/petro-station/petro11.jpg";
    ...
    <section>
      ...
      <div className="flex flex-col max-w-4xl mx-auto px-2 lg:px-0 xl:max-w-7xl">
        ...
        <div className="policy mb-5 mx-auto bg-white md:px-5 md:py-10 md:mb-10">
          ...
          <p>
            At <a href="#home">Real Archers Studio</a>, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by
            <a href="#home"> Real Archers</a> and how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            that they shared and/or collect in <a href="#home/">Reel Archers</a>
          ...
          <p>
            <a href="#home">Reel Archers</a> follows a standard procedure of
          ...
          <p>
            Like any other website, <a href="#home">Reel Archers</a> uses
