...
import image from "../../Assets/Projects/swimming/swim1.jpg";
...
const Terms = () => {
  return (
    <section>
      ...
      {/* container */}
      <div className="flex flex-col max-w-4xl mx-auto px-2 lg:px-0 xl:max-w-7xl">
        ...
        <div className="policy mb-5 mx-auto bg-white md:px-5 md:py-10">
          ...
          <p>
            Other than the content you own, under these Terms, Renters Success
          ...
          <p>
            ...
            you and Renters Success may further restrict access by you to any
          ...
          <p>
            ...
            Renters Success a non-exclusive, worldwide irrevocable, sub
          ...
          <p>
            ...
            third-party’s rights. Renters Success reserves the right to remove
          ...
          <h2>No warranties</h2>
          <p>
            This Website is provided "as is," with all faults, and Renters
            Success express no representations or warranties, of any kind
          ...
          <p>
            In no event shall Renters Success, nor any of its officers,
            ...
            such liability is under contract.  Renters Success, including its
          ...
          <p>
            You hereby indemnify to the fullest extent Renters Success from and
          ...
          <p>
            Renters Success is permitted to revise these Terms at any time as it
            sees fit, and by using this Website you are expected to review these
            Terms on a regular basis.
          </p>
          <h2>Assignment</h2>
          <p>
            The Renters Success is allowed to assign, transfer, and subcontract
          ...
          <p>
            These Terms constitute the entire agreement between Renters Success
          ...
          <p>
            ...
            the laws of the State of ke, and you submit to the non-exclusive
            jurisdiction of the state and federal courts located in ke for the
